...
class Avaria
{
    ...
    public function getCobradoCliente()
    {
        return $this->cobradoCliente;
    }
    ...
    public function setIdLocacao($v)
    {
        $this->idLocacao = $v;
    }
    ...
    public function setValorReparo($v)
    {
        $this->valorReparo = $v;
    }
    ...
    public function setCobradoCliente($v)
    {
        $this->cobradoCliente = $v;
    }
}
