...
class Locacao {
    ...
    public function getIdAgenciaRetirada()     { return $this->idAgenciaRetirada; }
    public function getIdAgenciaDevolucao()    { return $this->idAgenciaDevolucao; }
    public function getDataRetirada()          { return $this->dataRetirada; }
    public function getDataDevolucaoPrevista() { return $this->dataDevolucaoPrevista; }
    public function getDataDevolucaoReal()     { return $this->dataDevolucaoReal; }
    public function getValorDiaria()           { return $this->valorDiaria; }
    public function getTotalDias()             { return $this->totalDias; }
    ...
    public function setIdAgenciaRetirada($v)     { $this->idAgenciaRetirada = $v; }
    public function setIdAgenciaDevolucao($v)    { $this->idAgenciaDevolucao = $v; }
    public function setDataRetirada($v)          { $this->dataRetirada = $v; }
    public function setDataDevolucaoPrevista($v) { $this->dataDevolucaoPrevista = $v; }
    public function setDataDevolucaoReal($v)     { $this->dataDevolucaoReal = $v; }
    public function setValorDiaria($v)           { $this->valorDiaria = $v; }
    public function setTotalDias($v)             { $this->totalDias = $v; }
    public function setValorTotal($v)            { $this->valorTotal = $v; }
    public function setStatus($v)                { $this->status = $v; }
    public function setObservacoes($v)           { $this->observacoes = $v; }
    public function setDataCriacao($v)           { $this->dataCriacao = $v; }
}
