...
class Veiculo
{
    ...
    public function setAnoFabricacao($v)
    {
        $this->anoFabricacao = $v;
    }
    public function setAnoModelo($v)
    {
        $this->anoModelo = $v;
    }
    ...
    public function setQuilometragem($v)
    {
        $this->quilometragem = $v;
    }
    public function setCombustivel($v)
    {
        $this->combustivel = $v;
    }
    public function setNumPortas($v)
    {
        $this->numPortas = $v;
    }
    public function setCapacidadePassageiros($v)
    {
        $this->capacidadePassageiros = $v;
    }
}
