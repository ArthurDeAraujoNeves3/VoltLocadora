...
class Cliente {
    ...
    public function getVencimentoCnh() { return $this->vencimentoCnh; }
    ...
    public function setVencimentoCnh($v) { $this->vencimentoCnh = $v; }
    public function setEndereco($v)      { $this->endereco = $v; }
    public function setCidade($v)        { $this->cidade = $v; }
    public function setEstado($v)        { $this->estado = $v; }
    public function setCep($v)           { $this->cep = $v; }
    public function setDataCadastro($v)  { $this->dataCadastro = $v; }
