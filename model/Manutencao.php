...
class Manutencao
{
    ...
    public function getQuilometragemEntrada()
    {
    ...
    public function setDataEntrada($v)
    {
        $this->dataEntrada = $v;
    }
    public function setDataSaida($v)
    {
        $this->dataSaida = $v;
    }
    ...
    public function setQuilometragemEntrada($v)
    {
        $this->quilometragemEntrada = $v;
    }
}
